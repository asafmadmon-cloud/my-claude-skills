...
> A collection of Claude Code skills for investment research — built on Warren Buffett's principles.
...
A Senior Investment Strategist skill applying Warren Buffett's "Circle of Competence" framework. Every analysis produces a **Buffett Score (0–100)** with a clear buy/hold/sell recommendation backed by data-driven calculations.
...
Open `strategic-stock-analysis-pilot/SKILL.md` and replace:
```
